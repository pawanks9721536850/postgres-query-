...
-- INSERTING A VALUES IN AGENTS TABLE 
...
INSERT INTO ORDERS VALUES('200113', '4000.00', '600.00', '2008-10-06', 'C00022', 'A002', 'SOD');
...
INSERT INTO ORDERS VALUES('200117', '800.00', '200.00', '2008-10-21', 'C00014', 'A001', 'SOD');
...
select customer.cust_name , customer.cust_city  from customer  left join orders  
on customer.AGENT_CODE = orders.AGENT_CODE ;
